...
public class ServiceAspect {
    ...
    private void logBeforeSaveStudentServiceMethod(JoinPoint joinPoint) {
        LOGGER.info("Before the execution of saveStudent: " + joinPoint.getSignature());
    }

    @After("execution(* platform.codingnomads.co.aspectorientedprogramming.aop.service.StudentService.saveStudent())")
    private void logAfterSaveStudentServiceMethod(JoinPoint joinPoint) {
        LOGGER.info("Before the execution of saveStudent: " + joinPoint.getSignature());
    }
}
